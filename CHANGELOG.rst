...
- auth_source_ldap - add ``cacert`` parameter to supply PEM-encoded CA certificate(s) for LDAPS (https://github.com/theforeman/foreman-ansible-modules/pull/1985)
...
- content_view - scope ``lifecycle_environments`` lookup by organization (https://github.com/theforeman/foreman-ansible-modules/pull/1980)
